#Este código acessa um artigo específico do site g1.globo.com/pi/piaui/ e captura e imprime o título, o subtítulo, o autor, a data e o link. 
#
...
def integracao(url): 
    ...
    if not (os.path.isfile(arquivo)):
        ...
        with open(arquivo) as f:
            b=f.read()
        f.close()
    # A captura do título, subtítulo, autor, data e link abaixo.
